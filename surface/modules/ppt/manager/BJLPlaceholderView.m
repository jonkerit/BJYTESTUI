...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        [contentView bjl_makeConstraints:^(BJLConstraintMaker *make) {
        ...
        [self.textLabel bjl_makeConstraints:^(BJLConstraintMaker *make) {
            make.top.equalTo(self.imageView.bjl_bottom).with.offset(BJLScViewSpaceL);
