...
#import "BJLScUserGroupView.h"
#import "BJLViewImports.h"
#import "BJLScAppearance.h"

@interface BJLScUserGroupView ()
...
@implementation BJLScUserGroupView
...
- (void)updateWithGroup:(BJLUserGroup *)group
    ...
    self.groupNameLabel.numberOfLines = selected ? 2 : 1;
...
- (void)makeSubViews {
    ...
    self.openButton = ({
        ...
        [button setImage:[UIImage bjlsc_imageNamed:@"bjl_usergroup_close"] forState:UIControlStateNormal];
        [button setImage:[UIImage bjlsc_imageNamed:@"bjl_usergroup_open"] forState:UIControlStateSelected];
    ...
    self.groupColorButton = ({
        ...
        [button setImage:[UIImage bjlsc_imageNamed:@"bjl_usergroup_selected"] forState:UIControlStateSelected];
