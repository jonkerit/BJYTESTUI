...
- (void)configureWithRank:(NSInteger)rank userName:(nullable NSString *)userName score:(NSInteger)score {
    ...
    switch (rank) {
        case 1:
            self.rankImageView.image = [UIImage bjlsc_imageNamed:@"bjl_ic_envelope_first"];
            break;
            
        case 2:
            self.rankImageView.image = [UIImage bjlsc_imageNamed:@"bjl_ic_envelope_second"];
            break;
            
        case 3:
            self.rankImageView.image = [UIImage bjlsc_imageNamed:@"bjl_ic_envelope_third"];
            break;
