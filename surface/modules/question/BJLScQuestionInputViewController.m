...
- (void)makeSubviewsAndConstraints {
    ...
    self.sendQuestionButton = [self makeButtonWithTitle:nil image:[UIImage bjlsc_imageNamed:@"bjl_sc_question_send"] backgroundColor:[UIColor bjlsc_blueBrandColor] action:@selector(sendQuestion)];
...
- (void)updateConstraints {
    ...
    textAttachment.image = [UIImage bjlsc_imageNamed:@"bjl_sc_pencil"];
    ...
    [placeholder appendAttributedString:[[NSAttributedString alloc] initWithString:self.question ? @"请输入回复" : @" 请输入提问内容" attributes:@{NSFontAttributeName : [UIFont systemFontOfSize:14.0], NSForegroundColorAttributeName : [UIColor bjlsc_lightGrayTextColor], NSParagraphStyleAttributeName : paragraphStyle}]];
