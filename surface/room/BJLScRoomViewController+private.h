...
@property (nonatomic) BJLHitTestView *lotteryLayer; // 抽奖的layer, 在loadingLayer的下一层
...
@property (nonatomic) UIButton *handUpButton, *fullHandUpButton, *videoButton, *audioButton;
@property (nonatomic) UIButton *fullscreenButton, *restoreButton, *noticeButton, *questionButton, *eyeProtectedButton, *fullScreenEyeProtectedButton;
@property (nonatomic) BOOL controlsHidden, toolHidden, questionRedDotHidden; // 状态和视图实际的状态保持一致
@property (nonatomic) UILabel *speakRequestRedDot, *fullSpeakRequestRedDot, *questionRedDot;
@property (nonatomic) BJLAnnularProgressView *handProgressView, *fullHandProgressView;
