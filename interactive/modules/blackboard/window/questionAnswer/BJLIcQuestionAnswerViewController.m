...
- (void)makeEditContainView {
    ...
    self.choosenButton = ({
        ...
        [button setTitleColor:BJLIcTheme.subButtonTextColor forState:UIControlStateNormal];
        [button setBackgroundColor:[BJLIcTheme brandColor]];
    ...
    self.judgementButton = ({
        UIButton *button = [UIButton new];
        [button setTitle:@"判断题" forState:UIControlStateNormal];
        [button setBackgroundColor:[BJLIcTheme subButtonBackgroundColor]];
        [button setTitleColor:BJLIcTheme.buttonTextColor forState:UIControlStateSelected];
        [button setTitleColor:BJLIcTheme.subButtonTextColor forState:UIControlStateNormal];
        [button.titleLabel setFont:[UIFont systemFontOfSize:14]];
        button.layer.cornerRadius = BJLIcAppearance.toolboxCornerRadius;
    ...
    self.shuoldShowCorrectAnswerButton = ({
        ...
        [button setTitleColor:BJLIcTheme.viewSubTextColor forState:UIControlStateSelected];
    ...
    [self.topChoosenContainView bjl_makeConstraints:^(BJLConstraintMaker * _Nonnull make) {
        make.top.equalTo(self.editContainerView).offset(BJLIcAppearance.userWindowDefaultBarHeight + 10);
    ...
    [view bjl_makeConstraints:^(BJLConstraintMaker * _Nonnull make) {
        make.edges.equalTo(self.judgeTitleButton);
    }];
    ...
    self.judgeTitleTableView = ({
        ...
        tableView.backgroundColor = BJLIcTheme.windowBackgroundColor;
        tableView.layer.borderColor = BJLIcTheme.buttonBorderColor.CGColor;
    ...
    [self.judgementContainView bjl_makeConstraints:^(BJLConstraintMaker * _Nonnull make) {
        ...
        make.height.equalTo(@(BJLIcAppearance.questionAnswerOptionButtonHeight * 2 + (isIphone ? 5 : 15)));
    }];
    ...
    [self.rightButtonView bjl_makeConstraints:^(BJLConstraintMaker * _Nonnull make) {
        make.width.height.equalTo(@(BJLIcAppearance.questionAnswerOptionButtonHeight));
    ...
    self.minusOptionButton = ({
        ...
        [button setBackgroundColor:BJLIcTheme.toolButtonTitleColor];
    ...
    if (self.answerSheet.answerType == BJLAnswerSheetType_Choosen) {
        optionsViewHeight = ([self.answerSheet.options count] <= 4
                             ? BJLIcAppearance.questionAnswerOptionButtonHeight
                             : BJLIcAppearance.questionAnswerOptionButtonHeight * 2 + (isIphone ? 5 : 15)); // 1~2 行选项
        optionsViewWidth = [self.answerSheet.options count] <= 4
        ? (BJLIcAppearance.questionAnswerOptionButtonHeight * [self.answerSheet.options count] + (isIphone ? 10 : 25) * ([self.answerSheet.options count] - 1))
        : (BJLIcAppearance.questionAnswerOptionButtonHeight * 4 + (isIphone ? 10 : 25) * 3);
    }
    else {
        optionsViewHeight = 75;
        optionsViewWidth = BJLIcAppearance.questionAnswerOptionButtonHeight*2 + 25;
    }
    ...
    self.commentsTextView = ({
        ...
        textView.bjl_placeholderLabel.textColor = [BJLIcTheme viewSubTextColor];
        textView.bjl_placeholderLabel.textAlignment = NSTextAlignmentLeft;
        textView.backgroundColor = [UIColor colorWithWhite:0 alpha:0.1];
        textView.layer.cornerRadius = BJLIcAppearance.toolboxCornerRadius;
        textView.layer.borderColor = BJLIcTheme.buttonBorderColor.CGColor;
        textView.textColor = BJLIcTheme.viewTextColor;
    ...
    self.minusTimeButton = ({
        ...
        [button setTitleColor:BJLIcTheme.toolButtonTitleColor forState:UIControlStateHighlighted];
        [button setTitleColor:BJLIcTheme.toolButtonTitleColor forState:UIControlStateHighlighted | UIControlStateNormal];
        [button setTitleEdgeInsets:UIEdgeInsetsMake(0, 0, 3, 0)];
    ...
    self.timeTextField = ({
        ...
        textField.layer.borderColor = BJLIcTheme.buttonBorderColor.CGColor;
    ...
    UIView *coverView = [BJLHitTestView new];
    coverView.backgroundColor = [UIColor colorWithWhite:0 alpha:0.05];
    [self.editContainerView addSubview:coverView];
    [coverView bjl_makeConstraints:^(BJLConstraintMaker * _Nonnull make) {
        make.left.right.equalTo(self.editContainerView);
        make.top.equalTo(self.editContainerView).offset(BJLIcAppearance.userWindowDefaultBarHeight);
        make.bottom.equalTo(self.editContainerView).offset(-bottomBarHeight);
    }];
}
...
- (void)makePublishContainView {
    ...
    self.answerOptionsCollectionView = ({
        ...
        layout.sectionInset = UIEdgeInsetsZero;
        layout.scrollDirection = UICollectionViewScrollDirectionVertical;
        layout.itemSize = CGSizeMake(BJLIcAppearance.questionAnswerOptionButtonHeight, 75);
        layout.minimumInteritemSpacing = isIphone ? 10 : 25;
        // view
        UICollectionView *view = [[UICollectionView alloc] initWithFrame:CGRectZero collectionViewLayout:layout];
        view.backgroundColor = [UIColor clearColor];
    ...
    [self.countDownTimeLabel bjl_makeConstraints:^(BJLConstraintMaker * _Nonnull make) {
        make.top.equalTo(self.publishContainerView).offset(BJLIcAppearance.userWindowDefaultBarHeight + 10);
    ...
    CGFloat optionsViewWidth = (BJLIcAppearance.questionAnswerOptionButtonHeight * [self.answerSheet.options count] + (isIphone ? 10 : 25)*([self.answerSheet.options count] - 1));
    ...
    UIView *coverView = [BJLHitTestView new];
    coverView.backgroundColor = [UIColor colorWithWhite:0 alpha:0.05];
    [self.publishContainerView addSubview:coverView];
    [coverView bjl_makeConstraints:^(BJLConstraintMaker * _Nonnull make) {
        make.left.right.equalTo(self.publishContainerView);
        make.top.equalTo(self.publishContainerView).offset(BJLIcAppearance.userWindowDefaultBarHeight);
        make.bottom.equalTo(self.publishContainerView).offset(-bottomBarHeight);
    }];
}
...
- (void)makeEndContainView {
    ...
    self.statisticsLine = ({
        ...
        view.backgroundColor = BJLIcTheme.viewTextColor;
    ...
    [self.answerUseTimeLabel bjl_makeConstraints:^(BJLConstraintMaker * _Nonnull make) {
        make.top.equalTo(self.endContainerView).offset(BJLIcAppearance.userWindowDefaultBarHeight + 10);
    ...
    [self.detailTableView bjl_makeConstraints:^(BJLConstraintMaker * _Nonnull make) {
        make.top.equalTo(self.detailContainerView).offset(BJLIcAppearance.userWindowDefaultBarHeight);
    ...
    UIView *coverView = [BJLHitTestView new];
    coverView.backgroundColor = [UIColor colorWithWhite:0 alpha:0.05];
    [self.endContainerView addSubview:coverView];
    [coverView bjl_makeConstraints:^(BJLConstraintMaker * _Nonnull make) {
        make.left.right.equalTo(self.endContainerView);
        make.top.equalTo(self.endContainerView).offset(BJLIcAppearance.userWindowDefaultBarHeight);
        make.bottom.equalTo(self.endContainerView).offset(-bottomBarHeight);
    }];
}
...
- (void)updateEndContainerView {
    ...
    self.answerUseTimeLabel.text = [NSString stringWithFormat:@"用时：%02i:%02i", minutes, second];
    //发布人数
...
- (void)updateCountDownShowTime {
    ...
    self.countDownTimeLabel.text = [NSString stringWithFormat:@"结束倒计时：%02i:%02i", minutes, second];
}
...
- (void)upadteQuestionTypeButton {
    BOOL isChoose = self.answerSheet.answerType == BJLAnswerSheetType_Choosen;
    self.choosenButton.selected = isChoose;
    self.judgementButton.selected = !isChoose;
    
    [self.choosenButton setBackgroundColor:isChoose ? [BJLIcTheme brandColor] : [BJLIcTheme subButtonBackgroundColor]];
    [self.judgementButton setBackgroundColor:!isChoose ? [BJLIcTheme brandColor] : [BJLIcTheme subButtonBackgroundColor]];
}
//点击选择题
...
- (CGSize)collectionView:(UICollectionView *)collectionView
  ...
  sizeForItemAtIndexPath:(NSIndexPath *)indexPath {
    if (collectionView == self.collectionView) {
        if (self.answerSheet.answerType == BJLAnswerSheetType_Choosen) {
            return CGSizeMake(BJLIcAppearance.questionAnswerOptionButtonHeight, BJLIcAppearance.questionAnswerOptionButtonHeight);
        }
        else {
            return CGSizeMake(BJLIcAppearance.questionAnswerOptionButtonHeight, 75);
        }
    }
    return CGSizeMake(BJLIcAppearance.questionAnswerOptionButtonHeight, 75);
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.row >= [[self judgeTitleArray] count]) {
        ...
        self.rightTextField.layer.cornerRadius = BJLIcAppearance.toolboxCornerRadius;
        ...
        self.wrongTextField.layer.cornerRadius = BJLIcAppearance.toolboxCornerRadius;
    }
    else {
        NSDictionary *dic = [[self judgeTitleArray] objectAtIndex:indexPath.row];
        NSString *rightString = [dic bjl_stringForKey:@"1"];
