...
- (void)viewDidLoad {
    ...
    self.topBar.backgroundColor = [BJLIcTheme windowBackgroundColor];
    self.bottomBar.hidden = YES;
    
    // lineView
    UIView *lineView = [UIView bjlic_createSeparateLine];
    [self.topBar addSubview:lineView];
    [lineView bjl_makeConstraints:^(BJLConstraintMaker * _Nonnull make) {
