...
- (void)makeSubviewsAndConstraints {
    ...
    [self.promptButton bjl_makeConstraints:^(BJLConstraintMaker * _Nonnull make) {
        ...
        make.top.equalTo(self.containerView).offset(BJLIcAppearance.promptCellSmallSpace);
        make.right.equalTo(self.containerView).offset(-BJLIcAppearance.promptCellLargeSpace);
    }];
...
- (void)updateWithPromptModel:(BJLIcPromptModel *)promptModel {
    if (promptModel.reachMaxDuration) {
        ...
        self.promptButton.backgroundColor = BJLIcTheme.warningColor;
    }
    else {
        self.containerView.hidden = NO;
        self.promptModel = promptModel;
        self.promptButton.userInteractionEnabled = YES;
        self.promptLabel.text = promptModel.prompt;
        self.promptLabel.textColor = BJLIcTheme.viewTextColor;
        self.promptButton.backgroundColor = BJLIcTheme.toolboxBackgroundColor;
    }
}
