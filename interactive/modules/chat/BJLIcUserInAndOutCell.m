...
- (void)makeMessageLabelAndConstraints {
    ...
    [self.nameLabel bjl_makeConstraints:^(BJLConstraintMaker * _Nonnull make) {
        ...
        make.left.greaterThanOrEqualTo(self.contentView).offset(BJLIcAppearance.chatViewMediumSpace);
    }];
}
...
- (void)makeMessageWithTimeLabelAndConstraints {
    ...
    [self.nameLabel bjl_makeConstraints:^(BJLConstraintMaker * _Nonnull make) {
        make.centerX.equalTo(self.contentView);
        make.top.equalTo(self.timeLabel.bjl_bottom).offset(BJLIcAppearance.chatViewSmallSpace);
        make.bottom.equalTo(self.contentView.bjl_bottom).offset(-BJLIcAppearance.chatViewSmallSpace);
        make.left.greaterThanOrEqualTo(self.contentView).offset(BJLIcAppearance.chatViewMediumSpace);
    }];
}
