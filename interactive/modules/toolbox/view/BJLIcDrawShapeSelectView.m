...
@interface BJLIcDrawShapeSelectView () <UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout>
    ...
    self.shapeOptionsView = ({
        UICollectionView *collectionView = [BJLIcDrawSelectionBaseView createSelectCollectionViewWithCellClass:[BJLIcToolboxOptionCell class]
                                                                                               scrollDirection:UICollectionViewScrollDirectionVertical
                                                                                                   itemSpacing:BJLIcAppearance.toolboxOffset
...
- (UICollectionReusableView *)collectionView:(UICollectionView *)collectionView viewForSupplementaryElementOfKind:(NSString *)kind atIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.section == 1) {
        header.backgroundColor = BJLIcTheme.separateLineColor;
        return header;
    }
...
minimumLineSpacingForSectionAtIndex:(NSInteger)section {
    ...
    return BJLIcAppearance.toolboxOffset;
}
...
minimumInteritemSpacingForSectionAtIndex:(NSInteger)section {
    ...
    return BJLIcAppearance.toolboxDrawSpace;
}
...
- (CGSize)expectedSize {
    CGSize size = CGSizeMake(BJLIcAppearance.toolboxDrawButtonSize * 4 + BJLIcAppearance.toolboxDrawSpace * 2,
                             BJLIcAppearance.toolboxDrawButtonSize * 4 + BJLIcAppearance.toolboxOffset * 5);
    return size;
}
