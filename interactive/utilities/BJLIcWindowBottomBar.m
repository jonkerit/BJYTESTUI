...
@implementation BJLIcWindowBottomBar
...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        self->_resizeHandleImageView = ({
            UIImageView *imageView = [UIImageView new];
            imageView.image = [UIImage bjlic_imageNamed:@"window_triangle"];
        ...
        [self.resizeHandleView bjl_makeConstraints:^(BJLConstraintMaker *make) {
            ...
            make.width.height.equalTo(@(BJLIcAppearance.userWindowDefaultBarHeight));
        }];
