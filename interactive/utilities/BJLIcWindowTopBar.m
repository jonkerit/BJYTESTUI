...
@implementation BJLIcWindowTopBar
...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        self->_backgroundView = ({
            ...
            imageView.image = [UIImage bjlic_imageNamed:@"window_topbar"];
        ...
        self->_maximizeButton = ({
            ...
            [button setImage:[UIImage bjlic_imageNamed:@"window_maximize"] forState:UIControlStateNormal];
            [button setImage:[UIImage bjlic_imageNamed:@"window_maximize_restore"] forState:UIControlStateSelected];
        ...
        self->_fullscreenButton = ({
            ...
            [button setImage:[UIImage bjlic_imageNamed:@"window_fullscreen"] forState:UIControlStateNormal];
            [button setImage:[UIImage bjlic_imageNamed:@"window_fullscreen_restore"] forState:UIControlStateSelected];
            [self addSubview:button];
            bjl_return button;
        });
